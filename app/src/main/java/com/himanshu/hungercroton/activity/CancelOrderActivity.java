...
public class CancelOrderActivity extends AppCompatActivity {
    ...
    private void btnData(RecyclerView orderRecyclerview, List<OrderListModel> albumList) {
        ...
        OrderListModel a = new OrderListModel("0", covers[0], "sohan", "Today 10:12", "#21541", "125", "Message : Hi please pack green salid in my order", "3");
        albumList.add(a);

        a = new OrderListModel("1", covers[0], "Mohan", "Today 11:12", "#2514", "200", "Message : Hi please pack green salid in my order", "3");
        albumList.add(a);

        a = new OrderListModel("2", covers[0], "Deepak", "Today 12:30", "#21541", "500", "Message : Hi please pack green salid in my order", "3");
        albumList.add(a);
